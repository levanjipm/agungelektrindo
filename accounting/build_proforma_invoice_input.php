...
<?php
	...
	$sql = "INSERT INTO code_proforma_invoice (date,name,taxing,customer_id,po_number,created_by,created_date)
	VALUES ('$date','$proforma_invoice_name','$taxing','$customer','$purchaseorder_number','$created_by',CURDATE())";
	$conn->query($sql);
