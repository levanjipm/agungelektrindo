...
<?php
		...
		$sql 					= "INSERT INTO code_proforma_invoice (date,name,taxing,customer_id,po_number,type,created_by,created_date,guid)
								VALUES ('$date','$proforma_invoice_name','$taxing','$customer','$purchaseorder_number','$proforma_invoice_type','$created_by',CURDATE(),'$guid')";
		$conn->query($sql);
