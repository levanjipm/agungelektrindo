<?php
	...
	if($event['isconfirm'] == 1 || mysqli_num_rows($result_event) == 0 || $role != 'superadmin'){
		...
		$sql 					= "SELECT id, sisa, price FROM stock_value_in WHERE sisa> 0 AND reference = '" . $reference . "' ORDER BY id ASC";
