...
<?php
	...
	$sql_delivery_order			= "SELECT name, date,customer_id,name,so_id FROM code_delivery_order WHERE id = '" . $do_id . "'";
...
<div class='row' style='background-color:#ccc;z-index:0;width:100%;height:100%;margin:0'>
	<div class='col-xs-10 col-xs-offset-1' id='printable' style='z-index:25;background-color:white;padding:0'>
		...
		<table class='table' style='text-align:center'>
			...
			<tbody>
<?php
	$sql 				= "SELECT service_delivery_order.quantity, service_sales_order.description, service_sales_order.unit FROM service_delivery_order
...
?>
				<tr>
					<td><?= $description ?></td>
					<td><?= number_format($quantity,0) . " " . $unit ?></td>
				</tr>
<?php
	}
?>
