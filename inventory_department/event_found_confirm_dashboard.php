...
?>
<head>
	<title>Confirm found goods</title>
</head>
<div class='main'>
	<h2 style='font-family:bebasneue'>Event</h2>
	<p style='font-family:museo'>Confirm found item event</p>
	<hr>
<?php
...
?>
	<h3 style='font-family:bebasneue'>General data</h3>
	<label>Event name</label>
	<p style='font-family:museo'><?= $row['event_name'] ?></p>
