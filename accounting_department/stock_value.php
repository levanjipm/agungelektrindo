...
<div class="main">
	<h2>Choose</h2>
	<a href="#">
		<button class="btn btn-primary" type="button">In</button>
	</a>
	<a href="#">
		<button class="btn btn-danger" type="button">Out</button>
	</a>
</div>
	...
	<div class="tab"><h3>Item Input</h3>
		<div class="container">
			...
			<div class="row" style="padding-top:10px;">
				...
				<div class="col-lg-3">
					<input id="price1" class="form-control" name="price1" style="width:100%" required></input>
				</div>
			</div>
			<div id="input_list">
			</div>
...
<script type="text/javascript"src="Scripts/value_in.js">Hey</script>