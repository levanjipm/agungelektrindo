<?php
	...
	session_start();
?>
<p>This salary slip is confidential, please do not show them to unauthorized parties</p>
<label>Period</label>
<form action='show_salary_slip' method='POST' id='salary_form' target='_blank'>
