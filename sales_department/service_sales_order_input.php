...
<?php
		...
		$sql_insert 	= "INSERT into code_salesorder (name,created_by,date,po_number,taxing,customer_id,value,label,type,seller,guid)
						VALUES ('$so_number','$user_id','$date','$po_number','$tax','$customer','0','','SRVC','$seller','$guid')";
		$result_insert 	= $conn->query($sql_insert);
		
		$sql_get 		= "SELECT id FROM code_salesorder WHERE guid = '$guid'";
