...
?>
	<table  class='table table-bordered' id="edititemtable" style="width:100%">
		<tr>
...
?>
			...
			<td>
				<button type='button' class='button_danger_dark' onclick='delete_customer(<?= $row['id'] ?>)' <?php if($disabled > 0){ echo ('disabled'); } ?>>
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<button type="button" class="button_default_dark" data-dismiss="modal" id='close_modal<?= $row['id'] ?>'>Close</button>
						<button type="button" class="button_success_dark" onclick='submit(<?= $row['id'] ?>)'>Edit</button>
					</div>
				</div>
			</div>
		</div>
