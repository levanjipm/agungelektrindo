<?php
	...
	$sql_insert = "INSERT INTO code_delivery_order (date,number,tax,name,customer_id,sent,isdelete,so_id) 
	VALUES ('$do_date','$do_number','$tax','$do_name','$customer','0','0','$so_id')";
