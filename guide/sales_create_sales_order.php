...
<div class='main'>
	...
	<h4 style='font-family:bebasneue'>Membuat order penjualan</h4>
	<p>Membuat penawaran harga dimulai dengan masuk ke departemen sales dan memilih <i>quotation</i> dan sub-menu <i>Create quotation</i></p>
	<br>
	<div style='text-align:center;padding:30px;'>
		<img src='images/create_quotation1.png' style='max-width:600px'></img>
	</div>
	...
	<p>Apabila sudah sesuai, klik tombol <i>proceed</i> dan lanjutkan ke halaman selanjutnya. Pada halaman selanjutnya anda akan diarahkan ke halaman untuk <i>display</i> yang digunakan untuk mencetak penawaran harga tersebut baik menjadi format PDF ataupun menjadi <i>hard copy</i></p>
	<p>Cetak penawaran harga tersebut sesuai dengan kebutuhan, dengan cara klik tombol <i>print</i> di bagian bawah halaman</p>
	<div style='text-align:center;padding:30px;'>
